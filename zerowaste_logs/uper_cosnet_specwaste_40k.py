...
data = dict(
    ...
    test=dict(
        ...
        data_root=
        '/home/mtech2025/Documents/project_CosNet/sdc1/spectralwaste_segmentation',
        img_dir='rgb/test',
        pipeline=[
    ...
    val=dict(
        ...
        type='SpectralWasteDataset'),
    workers_per_gpu=2)
data_root = '/home/mtech2025/Documents/project_CosNet/sdc1/spectralwaste_segmentation'
...
model = dict(
    ...
    decode_head=dict(
        ...
        type='UPerHead'),
    pretrained=
    '/home/mtech2025/Documents/project_CosNet/sdc1/prog_lab_cosnet/pretrain/model_best_fixed.pth',
